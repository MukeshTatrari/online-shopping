...
<div class="container" ng-app="ShoppingApp"
	...
	<div class="row" ng-init="pCtrl.fetchProducts()">
		...
		<div class="col-md-3">
			<%@include file="../shared/travelSidebar.jsp"%>
		</div>
...
body {
	background:
		url('https://res.cloudinary.com/dxqin8fbx/image/fetch/f_auto,q_auto:eco/https://dzh0sbrwpq3wf.cloudfront.net/attachments/pictures/870659/original/tour-package-banner.jpg')
		0 0/100% auto no-repeat fixed;
}
</style>
		...
		<!-- content after carosual -->

		<div class="row">
			<div class="col-xs-12">
				<h3 style="color: white">Recently Booked Tour Packages</h3>
				<hr />
			</div>
		</div>
