...
import com.mukesh.onlineshopping.model.CheckoutModel;
...
import com.mukesh.shoppingbackend.dto.OrderItem;
...
public class CheckoutHandler {
	...
	public List<Address> getShippingAddresses(CheckoutModel model) {
		...
		List<Address> addresses = userDAO.getShippingAddresses(model.getUser().getId());
